...
public class EmpDaoImpl 
{
    ...
    public String addEmployee(Emp emp)throws SQLException
    {
    ...
    public String deleteEmployee(Integer empId)throws SQLException
    {
    ...
    public String updateEmployee(Emp emp)throws SQLException
    {
    	return null;
    }
